/*
Ejecute eve y vea qué pasa.
Obtendrá el siguiente resultado:
 - datos-faltantes.c -
* test/los / datos perdidos.1.in:
ACEPTADO
...
El programa obtuvo datos del archivo missing-data.1.in. eve es lo suficientemente inteligente como para saber que
hay algo en missing-data.1.out, por lo que sabe cuál es la correcta
responder. Por eso eve sabe que su respuesta es "ACEPTABLE". Porque sabe
qué respuesta debería dar y cuál es la respuesta que dio. Entonces
compara su respuesta con la "correcta" y ve que coinciden.

Pero, ¿qué pasa con la regla número 2? Bueno, la respuesta a esa pregunta es simple. eve hace
